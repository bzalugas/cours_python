...
* Etape par étape
** Pré-requis
Il faut déjà avoir initialisé ta grille de puissance 4 avant de paramétrer l'affichaque car tu auras besoin de la taille de la grille et des éventuelles valeurs des cases.
...
1. A l'aide d'une double boucle imbriquée (pour parcourir la grille de puissance 4), il faut pour chaque case de la grille créer une cellule pour ton affichage (une cellule sera un Label()). Exemple à l'intérieur de la boucle:
   #+begin_src python
     ...
     # clic correspond à une fonction qui faut définir et qui sera lancée uniquement lorsque l'on clique sur une cellule.
     widgets[(i,j)] = cell
