...
Pour créer des variables globales, c'est très simple : c'est comme des variables normales, sauf qu'elles ne sont pas dans une fonctions. Pour notre cas, nous appelerons nos variables =grille=, =symboleJoueur1= et =symboleJoueur2= :
#+begin_src python
...
*** Étape 3 : Définir la fonction de lancement du jeu
